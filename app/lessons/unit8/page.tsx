  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-6" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-purple-400 text-sm font-bold tracking-widest uppercase mb-2">Unit 8</p>
        ...
        <div className="space-y-4">
          {unit8.sections.map((section) => (
            <Link key={section.id} href={`/lessons/unit8/${section.id}`}>
