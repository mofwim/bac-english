  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-6" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-purple-400 text-sm font-bold tracking-widest uppercase mb-2">Unit 7</p>
        <h1 className="text-2xl font-bold mb-1">Microorganisms</h1>
        <p className="text-gray-400 text-sm mb-8">اختر القسم الذي تريد دراسته</p>
        <div className="space-y-4">
          {unit7.sections.map((section) => (
            <Link key={section.id} href={`/lessons/unit7/${section.id}`}>
