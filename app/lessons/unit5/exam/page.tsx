    ...
    try {
      const response = await fetch('/api/chat', {
        ...
        body: JSON.stringify({
          ...
          lesson: 'Bac English Exam Practice Unit 5'
        }),
      });
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-4" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <Link href="/lessons/unit5" className="text-purple-400 text-sm mb-6 block">
          → العودة للوحدة الخامسة
        </Link>

        <p className="text-purple-400 text-xs font-bold tracking-widest uppercase mb-1">
          Unit 5 — تدرّب على الامتحان
        </p>
        ...
        {unit5Exam.sections.map((section) => (
