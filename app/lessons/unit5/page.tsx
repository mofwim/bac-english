    ...
    <main className="min-h-screen bg-gray-950 text-white p-6" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          {unit5.sections.map((section) => (
            <Link key={section.id} href={`/lessons/unit5/${section.id}`}>
