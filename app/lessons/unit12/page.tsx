...
export default function Unit12Page() {
  return (
    <main className="min-h-screen bg-gray-950 text-white p-6" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-purple-400 text-sm font-bold tracking-widest uppercase mb-2">Unit 12</p>
        <h1 className="text-2xl font-bold mb-1">Digital literacy</h1>
        <p className="text-gray-400 text-sm mb-8">اختر القسم الذي تريد دراسته</p>
        <div className="space-y-4">
          {unit12.sections.map((section) => (
            <Link key={section.id} href={`/lessons/unit12/${section.id}`}>
            ...
            <div className="bg-gray-900 hover:bg-gray-800 transition-colors rounded-2xl p-5 border border-purple-800 hover:border-purple-500 cursor-pointer">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">10 أقسام — AI يصحح فوراً</p> // تعديل عدد الاقسام ايضا للوحدات 10 و 11
                </div>
