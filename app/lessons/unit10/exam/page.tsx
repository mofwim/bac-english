    ...
    try {
      const response = await fetch('/api/chat', {
        ...
        body: JSON.stringify({
          ...
          lesson: 'Bac English Exam Practice Unit 10'
        }),
      });
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-4" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-purple-400 text-xs font-bold tracking-widest uppercase mb-1">Unit 10 — تدرّب على الامتحان</p>
        ...
        {unit10Exam.sections.map((section) => (
